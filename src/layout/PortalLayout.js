...
export const PortalLayout = () => {
  ...
  return (
    <div className="bg-blue-200 h-screen p-6">
      ...
      <div className="py-6">
        <input type="date" className="form-input rounded " ref={startDateRef} />
      </div>
      <div className="py-6">
        <button
      ...
      <div className="py-6 flex flex-wrap gap-4 place-items-center">
        <input value={year} type="text" className="form-input rounded"></input>
        <div>Years</div>
        <button
          className="bg-blue-500 font-bold py-2 px-4 rounded hover:bg-blue-400 text-white"
          onClick={() => {
      ...
      <div className="py-6 flex flex-wrap gap-4 place-items-center">
        <input
          value={month}
          type="text"
          className="form-input rounded place-items-center"
        ></input>
        <div>Months</div>
        <button
          className="bg-blue-500 font-bold py-2 px-4 rounded hover:bg-blue-400 text-white"
      ...
      <div className="py-6 flex flex-wrap gap-4 place-items-center">
        <input value={day} type="text" className="form-input rounded "></input>
        <div>Days</div>
        <button
          className="bg-blue-500 font-bold py-2 px-4 rounded hover:bg-blue-400 text-white"
          onClick={() => {
